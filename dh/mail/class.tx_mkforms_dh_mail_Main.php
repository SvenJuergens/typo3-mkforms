 ...
 * Copyright notice
 *
 * (c) 2013 das MedienKombinat GmbH <kontakt@dmk-ebusiness.de>
 * All rights reserved
 *
 ...
 *
 * @see http://wiki.dmk-ebusiness.de/index.php?title=Mkforms#datahandler:MAIL_als_toller_powermail_ersatz
 *
 * @package tx_mkforms
 * @subpackage tx_mkforms_dh
